...
summary(divorce_clean$divorce_num)
...
# Summary of the entire combined dataset
summary(combined_data)

# Summary of specific columns (e.g., marriage rate and divorce rate)
summary(combined_data$total_mRate)
summary(combined_data$divorce_rate)
...
# Summary of specific variables (e.g., marriage_rate)
summary(data_long$marriage_rate)
